...
#define ENABLE_RESTORE_CONTEXT (0)
#define HAS_UART_RS485_SUPPORT (1)
#define HAS_UART_9BIT_SUPPORT (1)
...
#define SEDI_UART_SFT_RST_REG (0x4060004C)
#define SEDI_UART_SFT_RST_MASK (0x3F)
...
typedef struct {
	...
	uint32_t det;   /**< Driver-ouptut Enable Timing. */
