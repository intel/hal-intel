...
/* PMU Registers */
#define PMU_SRAM_PG_EN			(SEDI_REG_BASE(PMU) + 0x0)
#define PMU_SRAM_PWR_STATUS		(SEDI_REG_BASE(PMU) + 0xF60)
#define PMU_SRAM_DEEPSLEEP		(SEDI_REG_BASE(PMU) + 0xF38)
#define PMU_PMC_HOST_RST_CTL		(SEDI_REG_BASE(PMU) + 0xF20)
#define PMU_SW_PG_REQ			(SEDI_REG_BASE(PMU) + 0xF14)
#define PMU_PMC_PG_WAKE			(SEDI_REG_BASE(PMU) + 0xF18)
#define PMU_INTERNAL_PCE		(SEDI_REG_BASE(PMU) + 0xF30)
#define PMU_D3_STATUS			(SEDI_REG_BASE(PMU) + 0x100)
#define PMU_GPIO_WAKE_MASK0		(SEDI_REG_BASE(PMU) + 0x250)
#define PMU_GPIO_WAKE_MASK1		(SEDI_REG_BASE(PMU) + 0x254)
...
#define PMU_ISH_FABRIC_CNT		(SEDI_REG_BASE(PMU) + 0x18)
#define PMU_PGCB_CLKGATE_CTRL		(SEDI_REG_BASE(PMU) + 0x54)

#define PMU_VNN_REQ			(SEDI_REG_BASE(PMU) + 0x3c)
#define VNN_REQ_IPC_HOST_WRITE		BIT(3)

#define PMU_VNN_REQ_ACK			(SEDI_REG_BASE(PMU) + 0x40)
#define PMU_VNN_REQ_ACK_STATUS		BIT(0)

#define PMU_VNNAON_RED			(SEDI_REG_BASE(PMU) + 0x58)
...
#define PMU_MASK_EVENT			(SEDI_REG_BASE(PMU) + 0x10)
...
#define PMU_RF_ROM_PWR_CTRL		(SEDI_REG_BASE(PMU) + 0x30)

#define PMU_LDO_CTRL			(SEDI_REG_BASE(PMU) + 0x44)
...
/* CCU Registers */
#define CCU_TCG_EN			(SEDI_REG_BASE(CCU) + 0x0)
#define CCU_BCG_EN			(SEDI_REG_BASE(CCU) + 0x4)
#define CCU_WDT_CD			(SEDI_REG_BASE(CCU) + 0x7c)
#define CCU_RST_HST			(SEDI_REG_BASE(CCU) + 0x3c)
#define CCU_TCG_ENABLE			(SEDI_REG_BASE(CCU) + 0x40)
#define CCU_BCG_ENABLE			(SEDI_REG_BASE(CCU) + 0x44)
#define CCU_BCG_MIA			(SEDI_REG_BASE(CCU) + 0x4)
#define CCU_BCG_UART			(SEDI_REG_BASE(CCU) + 0x8)
#define CCU_BCG_I2C			(SEDI_REG_BASE(CCU) + 0xc)
#define CCU_BCG_SPI			(SEDI_REG_BASE(CCU) + 0x10)
#define CCU_BCG_GPIO			(SEDI_REG_BASE(CCU) + 0x14)
#define CCU_BCG_DMA			(SEDI_REG_BASE(CCU) + 0x28)
#define CCU_AONCG_EN			(SEDI_REG_BASE(CCU) + 0xdc)
...
#define MISC_ISH_RTC_COUNTER0		(SEDI_REG_BASE(MISC) + 0x70)
#define MISC_ISH_RTC_COUNTER1		(SEDI_REG_BASE(MISC) + 0x74)
